...
public class GameLocations {
	...
	Location Forest = new OutdoorsArea("Forbidden Forest", 
			...
			"Welcome back to the Forbidden Forest, hmm, you get a really strange feeling that the trees seems to be talking", "Misty");
	...
	Location Hometown = new OutdoorsArea("Karakorum",
			...
			"Welcome back to Karakorum. The city of the great Khan",
			"Sunny");
	...
	Location Mountain = new OutdoorsArea("Mt.Doom",
			...
			"You are back at Mt.Doom. The flying rocks may harm you",
			"Fog");
	...
	Location Pub = new Room("MacLaren's Pub",
			...
			"You are back at MacLaren's Pub. Please, have a seat and enjoy something from the bar",
			"Light");
